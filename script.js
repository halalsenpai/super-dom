...
function setEvents(events, dom) {
  for (const key in events) {
    if (Object.hasOwnProperty.call(events, key)) {
      ...
      dom.addEventListener(key, event, false);
    }
  }
}
  ...
  Object.defineProperties(obj, {
    ...
    options: {
      value: [
        ...
        {
          key: 'class',
          value: schema.attributes.class
            ? schema.attributes.class
            : 'default-class',
        },
      ],
    },
...
const makeLink = (schema) => {
  ...
  Object.defineProperties(obj, {
    ...
    content: { value: schema.properties.content },
  });
  return [obj];
};
...
const makeAdvancedSearch = (schema) => {
          ...
          options: [
            {
              key: 'class',
              value:
                'filter-category-selections filter-category-search-selections',
            },
          ],
          children: [
            {
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      options: [
                        ...
                        {
                          key: 'placeholder',
                          value: schema?.properties?.search?.placeholder
                            ? schema?.properties?.search?.placeholder
                            : 'Search',
                        },
                      ],
                    },
                      ...
                      options: [
                        {
                          key: 'class',
                          value:
                            'info-button-icon icon-question fix-overflow-top info-box-fixed',
                        },
                      ],
                    },
                  ],
      ...
      switch (el.type) {
        case 'CHECKLIST':
          ...
          let obj = {
            node: 'div',
            options: [
              { key: 'class', value: 'filter-category filter-search-panel' },
            ],
            children: [
              {
                node: 'div',
              ...
              },
              {
                node: 'div',
                options: [
                  { key: 'class', value: 'filter-category-selections ' },
                ],
                children: [
                  {
                    node: 'div',
  ...
  Object.defineProperties(obj, {
    node: { value: 'div' },
    options: { value: [{ key: 'class', value: 'panel search-panel' }] },
    children: {
      value: [
        {
          node: 'div',
